...
<div class="review-layout">
    ...
    <aside class="card">
        ...
        <form class="form-grid" action="{{ $safeRoute('admin.kyc.decision',['application'=>$id]) }}" method="post" data-loading-form>@csrf
            ...
            <button class="btn btn-danger btn-block" name="decision" value="changes_requested" type="submit"><x-icon name="edit" />{{ $isFa?'رد و درخواست اصلاح':'Reject and request changes' }}</button>
