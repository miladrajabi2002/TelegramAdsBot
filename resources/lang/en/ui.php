...
return [
    ...
    'status' => [
        ...
        'changes_requested' => 'Rejected by support — changes required',
        'queued_for_telegram' => 'Ready for Telegram submission',
        'telegram_review' => 'Initially submitted to Telegram',
